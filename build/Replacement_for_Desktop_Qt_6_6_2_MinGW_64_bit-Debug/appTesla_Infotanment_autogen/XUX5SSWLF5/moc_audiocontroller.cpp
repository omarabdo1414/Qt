...
Q_CONSTINIT const QMetaObject AudioController::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAudioControllerENDCLASS_t,
        ...
        // method 'volumLevelChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'incrementVolumLevel'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void AudioController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->incrementVolumLevel((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AudioController::volumLevelChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioController::volumLevelChanged()
{
