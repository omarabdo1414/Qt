...
constexpr auto qt_meta_stringdata_CLASSHVACHandlerENDCLASS = QtMocHelpers::stringData(
    "HVACHandler",
    "targetTempratureChanged",
    "",
    "setTargetTemprature",
    "newTargetTemprature",
    "icreamentTargetTemprature",
    "value",
    "targetTemprature"
);
...
Q_CONSTINIT const QMetaObject HVACHandler::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHVACHandlerENDCLASS_t,
        // property 'targetTemprature'
        QtPrivate::TypeAndForceComplete<int, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<HVACHandler, std::true_type>,
        // method 'targetTempratureChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'setTargetTemprature'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'icreamentTargetTemprature'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void HVACHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->targetTempratureChanged(); break;
        case 1: _t->setTargetTemprature((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->icreamentTargetTemprature((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &HVACHandler::targetTempratureChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->targetTemprature(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setTargetTemprature(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void HVACHandler::targetTempratureChanged()
{
